...
import { DataTableDemo4 } from './demo4/data-table-demo4';
...
@NgModule({
  ...
  declarations: [ AppComponent, DataTableDemo1, DataTableDemo2, DataTableDemo3, DataTableDemo1Remote, DataTableDemo4 ],
